...
char batch[80];
int roll;
float dsa,os,mands,analog,sum,average;
};
void intro();
void mainmenu();
void enterdata();
...
void enterdata()
{
    ...
    cin>>s.roll;
    cout<<"ENTER YOUR DATA STRUCTURE MARK :";
    cin>>s.dsa;
    cout<<"ENTER YOUR OPERATING SYSTEM MARK :";
    cin>>s.os;
    cout<<"ENTER YOUR SIMULATION AND MODELLING MARK :";
    cin>>s.mands;
    cout<<"ENTER YOUR ANALOG ELETRONICS MARK :";
    cin>>s.analog;
    s.sum=s.dsa+s.os+s.mands+s.analog;
    s.average=(s.sum/4);
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT BATCH NUMBER ::"<<s.batch<<endl<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll<<endl<<endl;
        cout<<"\t\t\t\tDATA STRUCTURE MARK :"<<s.dsa<<endl<<endl;
        cout<<"\t\t\t\tOPERATING SYSTEM MARK :"<<s.os<<endl<<endl;
        cout<<"\t\t\t\tSIMULATION AND MODELLING MARK :"<<s.mands<<endl<<endl;
        cout<<"\t\t\t\tANALOG ELETRONICS MARK :"<<s.analog<<endl<<endl;
        cout<<"=================================================================================="<<endl;
        check=true;
    }
    infile.close();
...

{
    ...
    while(infile.read(reinterpret_cast<char*>(&s),sizeof(student)))
    {
        ...
        cout<<"\t\t\t\tSTUDENT BATCH NUMBER ::"<<s.batch<<endl;
        cout<<"\t\t\t\tSTUDENT ROLL NUMBER :"<<s.roll<<endl;
        cout<<"\t\t\t\tDATA STRUCTURE MARK :"<<s.dsa<<endl;
        cout<<"\t\t\t\tOPERATING SYSTEM MARK :"<<s.os<<endl;
        cout<<"\t\t\t\tSIMULATION AND MODELLING MARK :"<<s.mands<<endl;
        cout<<"\t\t\t\tANALOG ELETRONICS MARK :"<<s.analog<<endl;
        cout<<"\t\t\t\t================================================"<<endl;
        equality=true;
        }
    }
